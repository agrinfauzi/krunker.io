...
(function() {
    ...
    function onTick(me, world, inputs, renderer) {
        ...
        let target = world.players.list.filter(x => {
            x[vars.cnBSeen] = true; // Menampilkan nickname teman & lawan
        ...
        if (target) {
            ...
            /**
             Jika ingin Auto AIM ketika kondisik klik mouse, gunakan skrip dibawah
             }else if(controls[vars.mouseDownL]){
                 inputs[input.shoot] = 1;
             }
            **/
